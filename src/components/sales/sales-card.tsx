        ...
        <div className="border-b-2 bg-gray-200 border-neutral-100 px-6 py-3">
          <div className="flex justify-between">
            <div className="flex flex-row gap-6">
              <p className="text-sm font-bold">{saleData.title}</p>
              <p className="text-sm font-bold">{saleData.startTime.split("T")[0]}</p>
            </div>
            <div className="flex flex-row gap-6">
              <p className="text-sm font-bold">Buyer: {saleData.buyer}</p>
              <p className="text-sm font-bold">${saleData.price}.00</p>
            </div>
          </div>
        </div>
